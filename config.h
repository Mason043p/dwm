...
static const char col_cyan[]        = "#008000";
...
#include "shiftview.c"
// Includes keycode definitions for my audio mixer on keyboard
...
static Key keys[] = {
	...
	{ MODKEY,	                    XK_Return, spawn,          {.v = terminator } },
    { NULL,                         XK_Print,  spawn,          {.v = flameshotgui } },
    ...
    { MODKEY,                       XK_i,        spawn,        { .v = spotify } },
    { MODKEY,                       XK_u,        spawn,        { .v = steam  } },
    { MODKEY,                       XK_y,        spawn,        { .v = lutris } },
    TAGKEYS(                        XK_1,                      0)
	TAGKEYS(                        XK_2,                      1)
	TAGKEYS(                        XK_3,                      2)
	TAGKEYS(                        XK_4,                      3)
